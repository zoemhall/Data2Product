...
# ==============================================================================
# 3. RECONSTRUCT & METRICS (unchanged idea, using new fc_output)
# ==============================================================================
...
final_output <- full_dataset %>%
  ...
  mutate(
    ...
    Smoothed_Price = zoo::rollapply(Final_Price, width = 3, FUN = mean,
...
write.csv(final_output, "Final_Waste_Forecast_20Years_Improved.csv", row.names = FALSE)
message("Done! Saved with Improved Forecasting and Price Caps applied.")
