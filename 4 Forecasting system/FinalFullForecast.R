...
# Common list of vars to forecast
vars_to_forecast <- c(
...
# ==============================================================================
# SELF-SUFFICIENCY BRANCH (use your “winning” simple ARIMA + bootstrap)
# ==============================================================================
message("Step 3A: Forecasting (simple ARIMA + bootstrap) for self-sufficiency...")
...
# Future quantities (simple model)
future_self <- fc_self %>%
  as_tibble() %>%
  ...
  select(Country, Year, Type, Self_Sufficiency)

# Historical self-sufficiency (same formula on history)
...
# Historical variability per country-variable (for extra noise)
...
# Combine history + improved-forecast branch (for industry pipeline)
...
# ==============================================================================
# MERGE: SELF-SUFFICIENCY (simple) + INDUSTRY VALUE (improved)
# ==============================================================================
...
write.csv(
  final_output,
  "Final_Waste_Forecast_20Years_Combined_BestOfBoth.csv",
  row.names = FALSE
)

message("Done! Saved with best-of-both forecasting: simple self-sufficiency + improved industry value.")
